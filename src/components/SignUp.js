      ...
      <form onSubmit={handleSubmit} className="max-w-md w-full p-8 bg-gray-800 rounded-lg shadow-lg">
        ...
        <div className="mb-4">
          ...
          <input
            ...
            className="w-full p-3 border border-pink-500 rounded-md bg-gray-700 text-white focus:outline-none focus:ring-2 focus:ring-pink-500"
            required
          />
        </div>
        <div className="mb-4">
        ...
        <button type="submit" className="w-full py-2 px-4 bg-pink-500 text-white rounded-md hover:bg-pink-600 transition duration-300">Sign Up</button>
